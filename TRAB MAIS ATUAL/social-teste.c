...
int main()
{
    ...
    char *c = "claudio", *p ="paulo", *l="lucas";
    no_grafo *n, *n1, *n2, *n3;
    int v,u;
    ...
    int i, j, k;
    char *fio= "dados.txt";
    tabela_dispersao* tde;
    tde=tabela_carrega(fio,TAB_MSG);
    ...
    for(j=0; j<tde->tamanho; j++)
    {
        i = st_insere(est, tde->elementos[j]);
        if(i == 0)
        {
        printf("\n\n CERTO\n\n");
        }
